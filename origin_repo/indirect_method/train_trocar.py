...
train_path = join('..','..', 'simon_trocar_feb_27', 'train')
val_path = join('..','..', 'simon_trocar_feb_27', 'val')
...
train_dataset = indirectTrocarDataset(train_path, WINDOW, SKIP, in_joints, seal=seal, filter_signal=f, net=net)
val_dataset = indirectTrocarDataset(val_path, WINDOW, SKIP, in_joints, seal=seal, filter_signal=f, net=net)
